...
$participante= new participante('',$dni,$nombre,$apellido,$telefono,$correo,'Administrativo',0,$participacion,'a');
...
$sql="INSERT INTO detalle_participante (facultad,regimen,dependencia,id_participante,categoria) VALUES ('','','$dp','$id','$categoria')";
