                         ...
                         <div class="col-xs-6">  <!--tamañño 2 -->
                            <div class="container">
                                ...
                                <tr>
                                    ...
                                    <option value="<?php echo $area_nombre; ?>"><?php echo $area_nombre; ?></option>
                                    <?php
...
if($flag)
{
    echo '<div class="alert alert-success" align="center"><strong>Exito Escuela actualizada correctamente !!!</strong></div>' ; 
}

if($_SESSION['error']===TRUE)
{
    echo '<div class="alert alert-danger" align="center"><strong>Escuela no actualizada !!!</strong></div>' ;
