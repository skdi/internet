             ...
             <div class="container">
                <div class="row" id="m_tabla" >    
                    <div class="col-sm-3 col-md-3">
                        <a href="crear.php" class="btn btn-success "><span class="fa fa-plus"></span> INGRESAR NUEVA ESCUELA</a>         
                    </div>
                    <div class="col-sm-2 col-md-2"></div>
                    <div class="col-sm-4 col md-4"></div>
                    <div class="col-sm-3 col-md-3">
                        <div class="btn-group">
                        <button class="btn btn-primary " data-toggle="dropdown" id="boton">Filtrar por Area <span class="caret"></span></button>
