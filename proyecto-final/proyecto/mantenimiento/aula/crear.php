          ...
          <form action="clases/crear.php" method="post">
            <div class="row" id="table_re">  <!--TABLA PARA LOS REGISTROS-->
                   <br>
                    ...
                    <thead>
                    <tr>
                        <center><h1>INGRESAR NUEVA AULA</h1> </center>
                                ...
                                <tr>
                                    ...
                                    <?php
                                           ...
                                           while($d=mysqli_fetch_array($resultado)){
                                            ...
                                            <div class="col-xs-9">
                                                <label for="apell">NRO AULA :</label>
                                                <input class="form-control" id="n_aula" type="text" name="n_aula" required >
                                            </div>
                                      ...
                                      <br>
                                         <div class="col-xs-12">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <input type="submit" class="btn btn-success" value="Crear Aula">
                                            </form>
                                            </div>
                                          <div class="col-xs-12">
                                            <br>
...
if($flag)
{
    echo '<div class="alert alert-success" align="center"><strong>Aula creada correctamente</strong></div>' ; 
}

if($_SESSION['error']===TRUE)
{
    echo '<div class="alert alert-danger" align="center"><strong>Aula no creada</strong></div>' ;
