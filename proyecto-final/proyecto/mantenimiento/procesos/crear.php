          ...
          <form action="clases/crear.php" method="post">
            <div class="row" id="table_re">  <!--TABLA PARA LOS REGISTROS-->
                   <br>
                    ...
                    <thead>
                    <tr>
                        <center><h1>INGRESAR NUEVO PROCESO</h1> </center>
                                     ...
                                     <div class="form-group row">
                                      <br> 
                                         <div class="col-xs-9">
                                                ...
                                                <input class="form-control" id="nombre" type="date" name="fecha" required>
                                            </div>
                                            
                                            <div class="col-sm-6 col-md-6">
                                                <br>
                                                <input type="submit" class="btn btn-success" value="Crear Proceso">
                                            </form>
                                            </div>
