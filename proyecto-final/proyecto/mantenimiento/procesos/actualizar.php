          ...
          <form action="clases/actualizar.php" method="post">
            ...
            <div class="row" id="table_re">  <!--TABLA PARA LOS REGISTROS-->
                   <br>
                    ...
                    <thead>
                    <tr>
                        <center><h1>Actualizar Proceso</h1> </center>
                                     ...
                                     <div class="form-group row">
                                      <br>  
                                            <div class="col-xs-12">
                                                ...
                                                <input class="form-control" id="fecha" value="<?php echo $fecha; ?>" type="date" name="fecha" required>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <br>
                                                <a href="../procesos/" class="btn btn-danger ">
...
if($flag)
{
    echo '<div class="alert alert-success" align="center"><strong>Proceso actualizado correctamente !!!</strong></div>' ; 
}

if($_SESSION['error']===TRUE)
{
    echo '<div class="alert alert-danger" align="center"><strong>Proceso no actualizado</strong></div>' ;
