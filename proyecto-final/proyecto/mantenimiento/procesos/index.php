                ...
                <br>
                    ...
                    <?php
                       if(empty($_GET['fecha'])){
						      ...
						      $sql="SELECT id_proceso,nombre,fecha FROM proceso ORDER BY fecha";
                      ...
                      else
                        {
					       $bus=$_GET['fecha'];
					       if($bus<>"todas"){
						          $sql="SELECT id_proceso,nombre,fecha FROM `proceso` WHERE YEAR(fecha)='$bus' ";
					           }
                           else{
						          $sql="SELECTid_proceso,nombre,fecha FROM `proceso` ORDER BY fecha";
					           }
                     ...
                     $query=mysqli_query($con,$sql);
                        ...
                        while($d=mysqli_fetch_array($query))               
                             echo '<tr><td>'.$d['nombre'].'</td><td>'.$d['fecha'].'</td><td><a href="actualizar.php?id='.$d['id_proceso'].'" class="btn btn-warning"><span class="fa fa-edit "></span>Actualizar</a></td><td><a href="clases/eliminar.php?id='.$d['id_proceso'].'" class="btn btn-danger"><span class="fa fa-trash "></span>Eliminar </a></td>';
