    ...
    <body class="fixed-left">
        ...
        <div id="envoltura">
            ...
            <div class="row" id="tabla_sel" >
                <form id="preguntas" action="guardar.php" method="post" enctype="multipart/form-data">
                    <div class="container">
                          ...
                          <tbody>
                            <tr>
                              <td><div class="form-group">
                                    <label for="curso">Ingrese el nombre de la pregunta:</label>
                                    <input type="text" class="form-control" id="titulo" name="nombre_pre" placeholder="Ingrese el nombre de la imagen">
                                </div>
                            </td>
                            </tr>
                              <tr><td><input type="file" name="img_pre"></td>
                              </tr>
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <tr>
                                        <td><div class="form-group">
                                        <label for="curso">Ingrese el nombre de la imagen de sustento:</label>
                                        <input type="text" class="form-control" id="titulo" name="nombre_susten" placeholder="Ingrese el nombre de la imagen">
                                    </div>
                                </td>
                                    </tr>
                                <tr><td><input type="file" name="img_sus"></td>
                                </tr>
