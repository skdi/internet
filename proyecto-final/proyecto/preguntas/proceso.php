                        ...
                        <div class="col-sm-6">
                         <div class="row">
                            <form name="form1" method="POST" action="proceso.php">
                              ...
                              <div class="col-sm-9">
                                  <br>
                                 <label class="radio-inline"><input type="radio" name="estado" value="e" >Elegidos</label>
                                 <label class="radio-inline"><input type="radio" name="estado" value="n">No elegidos</label>
                                 <label class="radio-inline"><input type="radio" name="estado" value="3" >Ambas</label> 
                            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        <thead>
                            ...
                            <tbody>
                                ...
                                echo '<tr><td>'.$a['dni'].'-'.$a['apellido'].'-'.$a['nombre'].'</td><td>'.$esta.'</td><td>'.$d['area'].'</td><td><a href="ver_p.php?id_p='.$d['id_pregunta'].'" class="btn btn-info"><span class="fa fa-address-book"></span> Ver Pregunta</a></td>';
                            }
