...
(8, 'Turismo', 'Sociales'),
(9, 'Enfermeria', 'Biomedicas'),
(10, 'Medicina', 'Biomedicas'),
(11, 'Biologia', 'Biomedicas'),
(12, 'Agronomia', 'Biomedicas');
...
(39, 1231231, '123123', '1231231', '123123', '123123123', 'Administrativo', 0, 'Controlador_Puerta', 'a'),
...
(61, 1256478, 'Itachi', 'Uchiha', '4157245', '@itachi', 'Docente', 0, 'Controlador', 'a'),
(62, 8764111, 'Martin', 'Marcus', '154878223', '@gmartin', 'Administrativo', 0, 'Portero', 'a'),
(63, 12345611, 'Chavez', 'Chavez', '12314124', '@cjasp', 'Docente', 0, 'Formulador', 'a');
...
CREATE TABLE `pregunta` (
  ...
  `nombre_preg` varchar(38) DEFAULT NULL,
  `nombre_susten` varchar(38) DEFAULT NULL,
  `img_pre` varchar(200) DEFAULT NULL,
  `img_sus` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(8, 1, 48, 'Biomedicas', 22, 10, 'controlador'),
(9, 1, 55, 'Ingenierias', 4, 1, 'controlador'),
(12, 2, 63, 'Biomedicas', NULL, NULL, 'formulador'),
(13, 2, 49, 'Biomedicas', NULL, 11, 'conserje');
...
--
ALTER TABLE `aula`
  MODIFY `id_aula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT de la tabla `detalle_participante`
--
ALTER TABLE `detalle_participante`
  MODIFY `id_detalle_participante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `proceso_participante`
  MODIFY `id_proceso_participante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
