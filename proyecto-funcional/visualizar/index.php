                ...
                <br>
                    ...
                    <?php
                       if(empty($_GET['fecha'])){
						      ...
						      $sql="SELECT * FROM proceso ORDER BY fecha";
                      ...
                      else
                        {
					       $bus=$_GET['fecha'];
					       if($bus<>"todas"){
						          $sql="SELECT * FROM `proceso` WHERE YEAR(fecha)='$bus' ";
					           }
                           else{
						          $sql="SELECT * FROM `proceso` ORDER BY fecha";
					           }
                       ...
                       $query=mysqli_query($con,$sql);
                        ...
                        while($d=mysqli_fetch_array($query))               
                             echo '<tr><td>'.$d['nombre'].'</td><td>'.$d['fecha'].'</td><td><a href="pro_sel.php?id='.$d['id_proceso'].'" class="btn btn-success"><span class="fa fa-eye "></span> Seleccionar</a></td>';
