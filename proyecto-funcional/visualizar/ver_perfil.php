...
<html>
    ...
    <body class="fixed-left">
        ...
        <div class="row" id="detalle">
            ...
            <div class="col-sm-12">
                <fieldset disabled>
                    ...
                    <div class="col-xs-3">
                        ...
                        <input class="form-control" id="apll"  value="<?php echo $dni; ?>" name="dni" type="text" required>
                    </div> 
                    
                     
                    <div class="col-xs-3">
                        <label for="apll">Estado</label>
                        <input class="form-control" id="apll"  value="<?php echo $estado; ?>" name="apll" type="text" required>
                    </div>
                    
                    <div class="col-xs-3">
                        <label for="nom">Funcion que desempeño</label>
                        <input class="form-control" id="nom" value="<?php echo $fu ;?>" name="nom" type="text" required>
                    </div>
                      
                  <div class="col-xs-3">
                        <label for="correo">Area en que se Desempeño :</label>
                         <input class="form-control" id="correo" value="<?php echo $area; ?>" name="correo" type="text" required>
                   </div> 
                   
                    
                    <div class="col-xs-3">
                        <label for="telf">Correo:</label>
                        <input class="form-control" id="telf" value="<?php echo $correo; ?>" name="telf" type="text" >
                    </div>
                    
                    <div class="col-xs-3">
                        <label for="correo">Cantidad de Procesos asistidos :</label>
                        <input class="form-control" id="correo" value="<?php echo $asistencia; ?>" name="correo" type="text" required>
                    </div> 
                    <?php 
                        ...
                        <div class="col-xs-3">
                                ...
                                <input class="form-control" id="correo" value="<?php echo $nombre_escuela; ?>" name="correo" type="text" required>
                        </div>
                    <?php }
                        ...
                        <div class="col-xs-3">
                                <label for="correo">N°Aula en que se Desempeño:</label>
                                    <input class="form-control" id="correo" value="<?php echo  $aula; ?>" name="correo" type="text" required>
                        </div> 
                    <?php }?>       
            ...
            <div class="col-sm-6">
            <h3>Grafico historial participante :</h3>
                <div class="row">
                    <div class="col-sm-2">
                        <p>Año desde: </p>
                    </div>
                    ...
                    <div class="col-sm-1"> 
                        <input type="submit" class="btn btn-warning" value="MOSTRAR GRAFICO">
                    </div>
