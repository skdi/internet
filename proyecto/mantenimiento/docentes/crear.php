                                ...
                                <tr>
                                    <th>
                                     <div class="form-group row">
                                      <br>
                                      <div class="col-xs-9">
                                        <label for="fc">Facultad :</label>
                                        <input class="form-control" id="fc" type="text" name="fc">
                                      </div>
                                         
                                    <div class="col-xs-9">
                                        <label for="reg">Regimen :</label>
                                        <input class="form-control" id="reg" type="text" name="rg">
                                      </div>
                                      <div class="col-xs-9">
...
if($flag)
{
    echo '<div class="alert alert-success" align="center"><strong>Docente creado correctamente</strong></div>' ; 
}

if($_SESSION['error']===TRUE)
{
    echo '<div class="alert alert-danger" align="center"><strong>Docente no creado</strong></div>' ;
