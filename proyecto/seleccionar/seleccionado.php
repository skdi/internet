            ...
            <div class="col-sm-12 col-md-12">
                <br>
                    <?php
                          ...
                          $sql="SELECT * FROM proceso_participante inner join (SELECT * from participante ) as A ON proceso_participante.id_participante= A.id_participante and id_proceso='$id' and participacion='$fu' " ;
                        ?>
                        ...
                        <thead>
                            ...
                            <tbody>
                               <?php
                                ...
                                echo '<tr><td>'.$d['dni'].'</td><td>'.$d['apellido'].'</td><td>'.$d['nombre'].'</td><td>'.$esta.'</td><td>'.$d['area'].'</td><td>'.$d['tipo_nombre'].'</td>';
                            }
